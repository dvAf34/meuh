...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progression.put(1, alternative);
        progression.put(2, cliche);
        progression.put(3, cliche2);
        progression.put(4, creepy);
        progression.put(5, creepy2);
        progression.put(6, endless);
        progression.put(7, energetic);
        progression.put(8, grungy);
        progression.put(9, memories);
        progression.put(10, rebellious);
        progression.put(11, sad);
        progression.put(12, simple);
        progression.put(13, simple2);
        progression.put(14, wisful);
        ...
        minmaj.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    //mineur on récupère la clé en ajoutant 12


                } else {
                    // The toggle is disabled on est en majeur
                    tonalite.put(13, cm);
                    tonalite.put(14,cxm);
                    tonalite.put(15, dm);
                    tonalite.put(16,dxm);
    ...
    private List<Progression> generer(){
        ...
        final List<Progression> acc = new  ArrayList<>();
         ...
         alternative= 	new Progression("alternative",6,4,1,5);
         cliche= 		new Progression("cliche",1,5,6,4);
       cliche2= 		new Progression("cliche2",1,6,3,7);
        creepy= 		new Progression("creepy",1,6,4,5);
         creepy2= 		new Progression("creepy2",1,6,2,6);
         endless= 		new Progression("endless",1,6,2,4);
       energetic= 		new Progression("energetic",1,3,4,6);
         grungy= 		new Progression("grungy",1,4,3,6);
        memories= 		new Progression("memories",1,4,1,5);
        rebellious= 	new Progression("rebellious",4,1,4,5);
         sad= 			new Progression("sad",1,4,5,5);
         simple= 		new Progression("simple",1,4,1,4);
         simple2= 		new Progression("simple2",1,5,1,5);
        wisful=new Progression("wisful",1,1,4,6);
